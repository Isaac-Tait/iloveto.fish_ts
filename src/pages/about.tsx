  ...
  return (
    <div className='heropattern-bubbles-neutral-100 h-screen'>
      ...
      <div className='mx-auto max-w-6xl px-1'>
        ...
        <p>
          My name is Isaac Tait. I love to fish. I also love trail running,
          cycling, skiing, rock climbing, && backpacking. I also enjoy cooking
          vegan meals at home and listening to jazz.
        </p>
      ...
      <div className='flex justify-center'>
        ...
        >
          <svg
            ...
            height='16'
            fill='currentColor'
            className='h-12 w-12 pt-4 text-blue-500'
            viewBox='0 0 16 16'
          >
